...
- (void)step
{
    ...
    //added by zhemin
    if ([_delegate respondsToSelector:@selector(carousel:withCurrentIndex:toIncrease:)])
    {
        [_delegate carousel:self withCurrentIndex:self.currentItemIndex toIncrease:(_startVelocity > 0.0f)];
    }
    _pastIndex = (int)self.currentItemIndex;
